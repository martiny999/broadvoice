...
BV_DECLARE(bv16_encode_state_t *) bv16_encode_alloc(void);

BV_DECLARE(void) bv16_encode(bv16_encode_state_t *cs,
                            uint8_t *out,
                            const int16_t amp[]);

BV_DECLARE(void) bv16_encode_free(bv16_encode_state_t *s);


BV_DECLARE(bv16_decode_state_t *) bv16_decode_alloc(void);

BV_DECLARE(void) bv16_decode(bv16_decode_state_t *s,
                            int16_t amp[],
                            const uint8_t *in);

BV_DECLARE(void) bv16_fillin(bv16_decode_state_t *s,
                            int16_t amp[]);

BV_DECLARE(void) bv16_decode_free(bv16_decode_state_t *s);


BV_DECLARE(bv32_encode_state_t *) bv32_encode_alloc(void);

BV_DECLARE(void) bv32_encode(bv32_encode_state_t *s,
                            uint8_t *out,
                            const int16_t amp[]);

BV_DECLARE(void) bv32_encode_free(bv32_encode_state_t *s);


BV_DECLARE(bv32_decode_state_t *) bv32_decode_alloc(void);

BV_DECLARE(void) bv32_decode(bv32_decode_state_t *s,
                            int16_t amp[],
                            const uint8_t *in);

BV_DECLARE(void) bv32_fillin(bv32_decode_state_t *ds, 
                            int16_t amp[]);

BV_DECLARE(void) bv32_decode_free(bv32_decode_state_t *s);
